...
CREATE TABLE trades (
    ...
    FOREIGN KEY (proposer_player_id, game_id) REFERENCES players(id, game_id) ON DELETE CASCADE,
    FOREIGN KEY (target_player_id, game_id) REFERENCES players(id, game_id) ON DELETE CASCADE
);
...
CREATE TABLE headlines (
    ...
    news_source_id BIGINT NOT NULL REFERENCES news_sources(id) ON DELETE CASCADE,
    link TEXT NOT NULL
);
...
CREATE TABLE mentions (
    ...
    country_name_id BIGINT NOT NULL REFERENCES country_names(id) ON DELETE CASCADE
);